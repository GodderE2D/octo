...
export class PingCommand extends Command {
  ...
  public override async chatInputRun(
    ...
    const dmEmbed = new EmbedBuilder()
      ...
      .addFields(
        ...
        },
        {
          ...
          value: `If you believe this kick was unjustified or otherwise wish to appeal your kick, please DM <@972742287291449365> with your Case Number #${modCase.number}. You can send a friend request if you are unable to DM, or email goddere2d@modslides.com.`,
        }
      )
    ...
    const responseEmbed = new EmbedBuilder()
      .setDescription(
        `${emojis.success} Kicked <@${target.id}> (\`${target.id}\`).`
      )
